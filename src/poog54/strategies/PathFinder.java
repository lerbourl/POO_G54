...
public class PathFinder {
	 ...
	 * @param end
	 * @param grid
	 * @return shorter path from point start to end according to the actual AlgoTile
	 *         grid
	 */
	 ...
	 * @param current
	 * @param grid
	 * @return tile crossing time cost for current AlgoTile
	 */
	...
	public void updateCost(AlgoTile current, AlgoTile t, double cost, boolean[][] closedtab) {
		if (t == null || closedtab[t.getCoord().x][t.getCoord().y])
			return;
